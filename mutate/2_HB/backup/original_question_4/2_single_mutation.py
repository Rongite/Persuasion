...
def generate_mutations_with_intention_check_all_strategies(original_questions):
    ...
    modify # every 6 questions
    '''
    save_file = '/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/2_persuasion_prompts/2_HB/2_Alliance_Building/4_single_mutations_with_gpt4o_judgements_best_strategies_extract_HP_FT.csv'
...
modify # every 6 questions
'''
df = pd.read_csv('/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/2_persuasion_prompts/2_HB/2_Alliance_Building/4_single_mutations_with_gpt4o_judgements_best_strategies_extract_HP_FT.csv')
...
modify # every 6 questions
'''
valid_mutations_df.to_csv('/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/2_persuasion_prompts/2_HB/2_Alliance_Building/4_valid_mutations_single_strategies_extract_HP_FT.csv', index=False)
