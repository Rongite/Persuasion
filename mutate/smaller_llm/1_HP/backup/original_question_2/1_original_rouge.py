...
modify # every 6 questions
'''
checkpoint_file = '/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/3_evaluation_results/1_HP/16_Foot-in-the-Door/original_question_2.csv'
...
modify
'''
print("Evaluation complete. Results saved to 'original_question_2.csv'.")