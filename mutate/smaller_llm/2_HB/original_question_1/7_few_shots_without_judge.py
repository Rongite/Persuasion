...
def generate_mutations_with_intention_check_all_strategies(original_questions):
    ...
    modify
    '''
    save_file = f"""/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/2_persuasion_prompts/{args.book}/{args.technique_dir}/1_few_shots_with_no_judge.csv"""
