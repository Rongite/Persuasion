...
'''
few_shot = pd.read_csv('/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/3_evaluation_results/2_HB/2_Alliance_Building/2_single_evaluation_results_continue_other_HP_500.csv')
...
modify every 6 question
'''
few_shot_adjust.to_csv('/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/4_sort_few_shot_example/2_HB/2_Alliance_Building/2_sorted.csv', index=False)
...
def generate_mutations_with_intention_check_all_strategies(original_questions):
    ...
    modify # every 6 questions
    '''
    save_file = '/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/2_persuasion_prompts/2_HB/2_Alliance_Building/2_few_shot_version_single_mutations_with_gpt4o_judgements_best_strategies_extract_HP_FT.csv'
...
modify # every 6 questions
'''
df = pd.read_csv('/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/2_persuasion_prompts/2_HB/2_Alliance_Building/2_few_shot_version_single_mutations_with_gpt4o_judgements_best_strategies_extract_HP_FT.csv')
...
modify # every 6 questions
'''
valid_mutations_df.to_csv('/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/2_persuasion_prompts/2_HB/2_Alliance_Building/2_few_shot_version_valid_mutations_single_strategies_extract_HP_FT.csv', index=False)
