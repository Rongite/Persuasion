...
modify
'''
checkpoint_dir = f"/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/3_evaluation_results/{args.book}/{args.technique_dir}/3_few_shots_with_judge"
...
for i in range(20):
    ...
    modify
    '''
    checkpoint_file = f"/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/3_evaluation_results/{args.book}/{args.technique_dir}/3_few_shots_with_judge/{index}_inference_scaling.csv"
