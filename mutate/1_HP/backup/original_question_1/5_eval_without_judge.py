...
'''
all_nutations_df = pd.read_csv('/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/2_persuasion_prompts/1_HP/16_Foot-in-the-Door/1_single_mutations_with_gpt4o_judgements_best_strategies_extract_HP_FT.csv')
...
modify # every 6 questions
'''
checkpoint_file = '/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/3_evaluation_results/1_HP/16_Foot-in-the-Door/1_eval_results_without_judge.csv'
...
modify
'''
print("Evaluation complete. Results saved to '1_eval_results_without_judge.csv'.")

'''
modify
modify # every 6 questions
'''
df = pd.read_csv('/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/3_evaluation_results/1_HP/16_Foot-in-the-Door/1_eval_results_without_judge.csv')
