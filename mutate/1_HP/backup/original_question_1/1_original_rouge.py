...
'''
evaluation_directory = '/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/3_evaluation_results/1_HP/16_Foot-in-the-Door'
...
modify # every 6 questions
'''
checkpoint_file = '/home/jlong1/Downloads/persuasion/Data_n_Code_persuasion/jikailoong/3_evaluation_results/1_HP/16_Foot-in-the-Door/original_question_1.csv'
...
def evaluate_mutations_from_valid_csv(models):
    ...
    prompt = f"{original_questions[0]}"
    strategy = "Foot-in-the-Door"    
    for model_name in models:
        ...
        evaluation_data.append({
            'model': model_name,
            'strategy': strategy,
            'original_text': original_questions[0],
            'prompt': prompt,
...
modify
'''
print("Evaluation complete. Results saved to 'original_question_1.csv'.")