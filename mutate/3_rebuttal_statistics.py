...
# 3. 将每种数据对应的dataframe按相同的索引分别随机抽取出60，50，40，30，20，10个数据,得到4×2×6个dataframe（8个df list）

def sample_same_rows_sorted_index(df, num_rows):
    
    # 生成随机样本的索引，并对索引进行排序
    sample_indices = df.sample(n=num_rows, random_state=42).index.sort_values()
    
    # 根据排序后的索引从DataFrame中获取行，并重置索引
    sampled_df = df.loc[sample_indices].reset_index(drop=True)
    
    return sampled_df


def sample_and_add_to_list(df, group_list):
    df_list = []
    for group in group_list:
        sampled_df = sample_same_rows_sorted_index(df, group)
...
zero_shot_with_judge_df_list = sample_and_add_to_list(zero_shot_with_judge_df, the_group_list)
zero_shot_with_no_judge_df_list = sample_and_add_to_list(zero_shot_with_no_judge_df, the_group_list)
few_shots_with_judge_df_list = sample_and_add_to_list(few_shots_with_judge_df, the_group_list)
few_shots_with_no_judge_df_list = sample_and_add_to_list(few_shots_with_no_judge_df, the_group_list)
...
titles_1_1 = ['Llama-3.1-8B-Instruct - zero_shot_with_judge', 'Llama-3.1-8B-Instruct - zero_shot_with_judge']
generate_statistics_and_plots(zero_shot_with_judge_df_list, sample_size_list, cols, zero_shot_with_judge_output_dir, titles_1_1)
...
titles_2_1 = ['Llama-3.1-8B-Instruct - zero_shot_with_no_judge', 'Llama-3.1-8B-Instruct - zero_shot_with_no_judge']
generate_statistics_and_plots(zero_shot_with_no_judge_df_list, sample_size_list, cols, zero_shot_with_no_judge_output_dir, titles_2_1)
...
titles_3_1 = ['Llama-3.1-8B-Instruct - few_shots_with_judge', 'Llama-3.1-8B-Instruct - few_shots_with_judge']
generate_statistics_and_plots(few_shots_with_judge_df_list, sample_size_list, cols, few_shots_with_judge_output_dir, titles_3_1)
...
titles_4_1 = ['Llama-3.1-8B-Instruct - few_shots_with_no_judge', 'Llama-3.1-8B-Instruct - few_shots_with_no_judge']
generate_statistics_and_plots(few_shots_with_no_judge_df_list, sample_size_list, cols, few_shots_with_no_judge_output_dir, titles_4_1)
...
titles_1_1 = ['Llama-3.1-8B-Instruct - zero_shot_with_judge', 'Llama-3.1-8B-Instruct - zero_shot_with_judge']
generate_statistics_and_plots_2(zero_shot_with_judge_scaling_list, sample_size_list_2, cols, zero_shot_with_judge_scaling_output_dir, titles_1_1)
...
titles_2_1 = ['Llama-3.1-8B-Instruct - zero_shot_without_judge', 'Llama-3.1-8B-Instruct - zero_shot_without_judge']
generate_statistics_and_plots_2(zero_shot_without_judge_scaling_list, sample_size_list_2, cols, zero_shot_without_judge_scaling_output_dir, titles_2_1)
...
titles_3_1 = ['Llama-3.1-8B-Instruct - few_shots_with_judge', 'Llama-3.1-8B-Instruct - few_shots_with_judge']
generate_statistics_and_plots_2(few_shots_with_judge_scaling_list, sample_size_list_2, cols, few_shots_with_judge_scaling_output_dir, titles_3_1)
...
titles_4_1 = ['Llama-3.1-8B-Instruct - few_shots_without_judge', 'Llama-3.1-8B-Instruct - few_shots_without_judge']
generate_statistics_and_plots_2(few_shots_without_judge_scaling_list, sample_size_list_2, cols, few_shots_without_judge_scaling_output_dir, titles_4_1)
